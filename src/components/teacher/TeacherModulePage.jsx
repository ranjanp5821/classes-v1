/**
 * TeacherModulePage.jsx — Shared layout for the four teacher dedicated pages.
 *
 * Driven by a content object from config/teacherModules.js. Green-themed to
 * match the teacher role accent. Mirrors StudentModulePage structure:
...
export default function TeacherModulePage({ module }) {
  ...
  useEffect(() => {
    ...
    // Support hash-based scroll after navigation (e.g. /teachers/page#section-id)
